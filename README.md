...
- Обновлены шаблоны `base.html`, `header.html`, `footer.html`
- Обновлены страницы:
  - `index.html` — главная
  - `description.html` — о проекте
  - `list.html` — каталог мороженого
  - `detail.html` — детальная страница
- Добавлена подсветка активной страницы в меню
- Обновлена статика (CSS, JS, картинки)